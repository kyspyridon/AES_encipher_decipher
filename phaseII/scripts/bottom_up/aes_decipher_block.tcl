...
set link_library [ list $target_library $synthetic_library $bottom_up_results_path/aes_inv_sbox.ddc ]

set design_name aes_decipher_block
analyze -f verilog $rtl_path/aes_decipher_block.v
elaborate aes_decipher_block
current_design aes_decipher_block
